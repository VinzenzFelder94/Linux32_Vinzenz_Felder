#The files to look at for this homework assignment are the beaglebone memorymap pdf, GPIO_button_mmap.c, gpio_toggle.c, and and the directory with all sh.files for testen LCD
...
#The gpio_toggle.c is a file wich toggles on internal LED USRÂ3 
...
#movie.sh shows a movie on the Display, by changing the rotate= 1 you can rotate the video. 
